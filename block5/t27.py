...
# a) Сумма всех целых чисел от 100 до 500
sum_a = sum(range(100, 501))
print(f"Сумма чисел от 100 до 500: {sum_a}")

# б) Сумма всех целых чисел от a до 500 (a вводится с клавиатуры, a <= 500)
...
# в) Сумма всех целых чисел от -10 до b (b вводится с клавиатуры, b >= -10)
...
# г) Сумма всех целых чисел от a до b (a и b вводятся с клавиатуры, b >= a)
